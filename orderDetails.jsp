...
<body style="background-color: #ffff;">
 ...
 -->
	<div class="text-center"
		style="color: black; font-size: 24px; font-weight: bold;">Book
		Details</div>
	...
	<div class="container">
		<div class="table-responsive ">
			<table class="table table-hover table-sm">
				<thead
					style="background-color: #186188; color: white; font-size: 14px; font-weight: bold;">
					<tr>
						<th>Image</th>
						<th>PetName</th>
						<th>BookId</th>
				...
				<tbody
					...
					<tr>
						...
						<td><%=order.getTime()%></td>
						<td class="text-success"><%=order.getShipped() == 0 ? "Waiting" : "Arrived"%></td>
					</tr>
